<?php
/**
 * Copied from Largo at Largo 0.6.4 to:
 * - move avatar before the display name
 * - add another container element around the photo, for presentational purposes
 *
 * @since Largo 0.6.4
 */
...
if ( largo_has_avatar( $author_obj->user_email ) ) {
	echo '<div class="photo"><div class="photo-wrapper">' . get_avatar( $author_obj->ID, 96, '', $author_obj->display_name ) . '</div></div>';
	...
	echo '<div class="photo"><div class="photo-wrapper">' . $photo . '</div></div>';
}
